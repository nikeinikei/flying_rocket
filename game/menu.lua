...
function Menu.prototype.____constructor(self)
    GameState.prototype.____constructor(self)
    self.buttons = {}
    local buttonHeight = ____exports.Menu.buttonHeight
    local buttonWidth = ____exports.Menu.buttonWidth
    local startY = ____exports.Menu.buttonStartY
...
function Menu.prototype.setButtonPositions(self)
    local x = (love.graphics.getWidth() / 2) - (____exports.Menu.buttonWidth / 2)
    local buttonPadding = (love.graphics.getHeight() * 0.7) / #buttonSchemes
    do
        local i = 0
        while i < #self.buttons do
            ...
            button.x = x
            button.y = ____exports.Menu.buttonStartY + (i * buttonPadding)
            i = i + 1
        end
    end
end
function Menu.prototype.resize(self, width, height)
...
Menu.buttonWidth = 400
Menu.buttonHeight = 70
Menu.buttonStartY = 150
return ____exports
